...
const News = () => {
  ...
  const newsItems = [
    ...
    },
    {
      ...
      content: "The Annual Sports Day 2024 was a spectacular display of athletic prowess, teamwork, and school spirit. Students from Playgroup to Grade 5 participated in various events including track and field, relay races, football, and traditional games. The event emphasized participation over competition, with every student receiving recognition for their efforts. Parents and teachers cheered enthusiastically as young athletes demonstrated not only their physical abilities but also values of fair play and mutual respect.",
    ...
    },
    {
      ...
      content: "The Parent-Teacher Meetings for February 2024 provide an excellent opportunity for parents to engage directly with teachers and understand their child's academic progress, social development, and areas for improvement. Individual consultation slots are available for detailed discussions about each student's learning journey. These meetings are crucial for maintaining strong home-school partnerships that support student success.",
    ...
    },
    {
      ...
      content: "The Student Art Exhibition features an impressive collection of paintings, drawings, sculptures, and mixed-media artwork created by our talented Grade 4 students. The exhibition showcases the diverse artistic abilities and creative thinking fostered through our comprehensive arts curriculum. Visitors can explore themes ranging from nature and family to abstract expressions of emotion and dreams.",
    ...
    },
    {
      ...
      content: "Our new digital learning platform integrates seamlessly with classroom instruction to provide students with interactive educational content, virtual field trips, and collaborative projects. Teachers can now assign multimedia homework, track student progress in real-time, and provide personalized feedback. Parents also have access to monitor their child's learning journey through dedicated dashboards.",
    ...
    },
    {
      ...
      content: "Our community service project brought together students, teachers, and families to support the local elderly care center through donations, entertainment programs, and companionship visits. This initiative teaches students the importance of social responsibility and caring for community members while developing empathy and leadership skills.",
    ...
    <div className="pt-20">
      ...
      {featuredNews && (selectedCategory === 'All' || selectedCategory === featuredNews.category) && (
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-[#00393C] mb-2">Featured News</h2>
          ...
          {regularNews.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {regularNews.map((item) => (
                <article key={item.id} className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300">
                  <img
                    src={item.image}
                    alt={item.title}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="text-[#F68949] hover:text-[#946F5C] transition-colors text-sm font-medium">
                        Read More →
                      </button>
                    </div>
                  </div>
      ...
      <section className="py-16 bg-[#00393C] text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Important Announcements</h2>
            <p className="text-[#FFE8D2] text-lg">
              Critical updates and reminders for the ROOH school community
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-[#F68949] rounded-2xl p-6 text-center">
              <Calendar className="h-12 w-12 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-3">Admission Open 2024-25</h3>
              <p className="mb-4">
                Applications are now being accepted for the upcoming academic year. 
                Limited seats available.
              </p>
              <button className="bg-white text-[#F68949] px-6 py-2 rounded-full font-medium hover:bg-gray-100 transition-colors">
                Apply Now
              </button>
            </div>

            <div className="bg-[#946F5C] rounded-2xl p-6 text-center">
              <Clock className="h-12 w-12 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-3">Winter Break Schedule</h3>
              <p className="mb-4">
                School will remain closed from December 20th to January 5th. 
                Classes resume January 8th.
              </p>
              <button className="bg-white text-[#946F5C] px-6 py-2 rounded-full font-medium hover:bg-gray-100 transition-colors">
                View Calendar
              </button>
            </div>

            <div className="bg-[#FFE8D2] text-[#00393C] rounded-2xl p-6 text-center">
              <ArrowRight className="h-12 w-12 mx-auto mb-4 text-[#F68949]" />
              <h3 className="text-xl font-bold mb-3">Health Checkup Campaign</h3>
              <p className="mb-4">
                Annual health checkup for all students scheduled. 
                Medical forms must be submitted by January 20th.
              </p>
              <button className="bg-[#F68949] text-white px-6 py-2 rounded-full font-medium hover:bg-[#946F5C] transition-colors">
                Download Forms
              </button>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-[#00393C] mb-4">
            Stay Updated with ROOH News
          </h2>
          <p className="text-[#303E3F] text-lg mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-6 py-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#F68949] focus:border-transparent"
            />
            <button className="bg-[#F68949] text-white px-8 py-3 rounded-full font-medium hover:bg-[#946F5C] transition-colors">
              Subscribe
            </button>
          </div>
          
          <p className="text-[#303E3F] text-sm mt-4">
